...
var defaultFilters=reclineView.filters||{},filters=jQuery.extend({},defaultFilters,urlFilters);jQuery.each(filters,function(field,values){query.addFilter({type:'term',field:field,term:values});});if(window.parent.ckan.views&&window.parent.ckan.views.filters._searchParams.q){query.set({q:window.parent.ckan.views.filters._searchParams.q});}
